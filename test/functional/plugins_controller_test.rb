...
class PluginsControllerTest < ActionController::TestCase
  ...
  test "should create plugin" do
    assert_difference('Plugin.count') do
      post :create, plugin: { ip_address: @plugin.ip_address, plugin: @plugin.plugin, updated_at: @plugin.updated_at }
    end
  ...
  test "should update plugin" do
    put :update, id: @plugin, plugin: { ip_address: @plugin.ip_address, plugin: @plugin.plugin, updated_at: @plugin.updated_at }
    assert_redirected_to plugin_path(assigns(:plugin))
  end
